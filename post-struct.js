...
for (const file of fs.readdirSync(postsDir)) {
  ...
  const html = `
    ...
    <head>
        ...
        <link rel="preload" href="/stylesheets/style.css?v=3.8" as="style" onload="this.onload=null;this.rel='stylesheet'">
        <noscript><link rel="stylesheet" href="/stylesheets/style.css?v=3.8"></noscript>
